...
% for Phase I: QCD Foundation training.
    ...
    % CRITICAL: Set the LOCAL TEST MODE for the listener before running the core monitor.
    setenv('AEMS_TEST_MODE', 'LOCAL');
    
    monitor_and_ingest_core();
    
    % Clean up test mode environment variable after execution
    setenv('AEMS_TEST_MODE', '');

...
% MONITOR_AND_INGEST_CORE: The core logic that runs every cycle.
    ...
    % --- NEW: Master Source Repository URLs for Autonomous Scanning ---
...
%   This definition is the core DEPLOYED logic.
    ...
    if isempty(fusion_key)
        ...
        return; 
    end % <--- FIXED: Missing 'end' for the if statement
